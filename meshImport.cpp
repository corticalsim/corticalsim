...
void pickup_shape(Geometry* g)
{
        ...
        else
	{
		...
		string inputMeshFile = g->system->p.inputDir+"/"+inFile+".dat";
	...
	viewGraph(Gvertex,viewTriangle,centroid,g->system->p.outputDir.c_str());
	...
	fstream fp;    
        filename = g->system->p.outputDir+string("/MeshInfo.txt");
