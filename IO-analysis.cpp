...
void System::initializeOutput(void)
{
    ...
    string FileName = string(p.outputDir + string("/parameters.txt"));   
    ...
    FileName = string(p.outputDir + string("/measurements.txt"));
    ...
    FileName = string(p.outputDir + string("/Draw_MT_segments.txt"));
    ...
    FileName = string(p.outputDir + string("/heatMapOrder.txt"));
